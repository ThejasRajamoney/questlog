  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col items-center py-3 text-center">
        <div className="w-12 h-12 rounded-2xl bg-fuchsia-100 flex items-center justify-center mb-2">
          <Brain size={24} className="text-fuchsia-500" />
        </div>
        <p className="text-xs text-gray-400 font-medium">AI-powered planning coming soon</p>
      </div>
    ),
  },
  {
